...
use Fakeeh\Assessments\Domain\Models\{Exam, Topic, Question};
use Fakeeh\Assessments\Http\Requests\Admin\{StoreExamRequest, UpdateExamRequest};
...
class ExamController extends Controller
{
    ...
    public function store(StoreExamRequest $request)
    {
        ...
        try { $hash = app(\Fakeeh\Assessments\Services\SchemaHashService::class)->computeForExam($exam); $exam->schema_hash = $hash; $exam->save(); } catch (\Throwable $e) {}
    ...
    public function publish(Exam $exam)
    {
        ...
        $assembly = app(\Fakeeh\Assessments\Services\ExamAssemblyService::class);
