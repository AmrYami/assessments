...
use Streaming\Assessments\Domain\Models\{Exam, Topic, Question};
use Streaming\Assessments\Http\Requests\Admin\{StoreExamRequest, UpdateExamRequest};
...
class ExamController extends Controller
{
    ...
    public function store(StoreExamRequest $request)
    {
        ...
        try { $hash = app(\Streaming\Assessments\Services\SchemaHashService::class)->computeForExam($exam); $exam->schema_hash = $hash; $exam->save(); } catch (\Throwable $e) {}
    ...
    public function publish(Exam $exam)
    {
        ...
        $assembly = app(\Streaming\Assessments\Services\ExamAssemblyService::class);
